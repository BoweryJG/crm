...
INSERT INTO call_analysis (
    ...
    '2025-06-19 09:38:42-04:00', -- From your filename
    24, -- 24 minutes as mentioned
    'b2c3d4e5-f6a7-8901-bcde-f23456789012',
    'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
    ...
    0.7, -- Positive sentiment based on productive discussion
...
INSERT INTO sales_activities (
    ...
    'successful',
    (SELECT id FROM auth.users LIMIT 1), -- Links to first user, update as needed
    'c3d4e5f6-a7b8-9012-cdef-345678901234'
) ON CONFLICT (id) DO NOTHING;
...
UNION ALL
SELECT 'Contact Added:', first_name || ' ' || last_name, title, email FROM contacts WHERE id = 'b2c3d4e5-f6a7-8901-bcde-f23456789012'
UNION ALL
SELECT 'Contact Added:', first_name || ' ' || last_name, title, email FROM contacts WHERE id = 'e5f6a7b8-c9d0-1234-efab-678901234567'
UNION ALL
