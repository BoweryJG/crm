-- Clean version with all valid UUIDs
...
-- 5. Insert public_sales_activities (FIXED UUIDs - using 'e' prefix)
...
-- 8. Insert public_companies (FIXED UUIDs - using 'c0' prefix)
...
-- 9. Insert public_procedures (FIXED UUIDs - using 'f' prefix)
