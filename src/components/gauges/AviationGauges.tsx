...
const glow = keyframes`
  0%, 100% {
    box-shadow: 0 0 15px rgba(201, 176, 55, 0.5), 0 0 30px rgba(201, 176, 55, 0.3);
  }
  50% {
    box-shadow: 0 0 40px rgba(201, 176, 55, 0.8), 0 0 60px rgba(201, 176, 55, 0.5);
  }
`;
...
const GaugeContainer = styled(Paper)(({ theme }) => ({
  ...
  background: `
    radial-gradient(circle at 30% 30%, 
      rgba(201, 176, 55, 0.3) 0%, 
      rgba(40, 40, 40, 0.95) 40%, 
      rgba(30, 30, 30, 1) 100%
    )
  `,
  border: '3px solid #C9B037',
  boxShadow: `
    inset 0 0 30px rgba(201, 176, 55, 0.2),
    inset 0 0 60px rgba(201, 176, 55, 0.3),
    0 0 40px rgba(201, 176, 55, 0.5)
  `,
  ...
  return (
    <Box
      sx={{
        ...
        p: 2,
        background: `
          radial-gradient(circle at 20% 80%, rgba(201, 176, 55, 0.15) 0%, transparent 50%),
          radial-gradient(circle at 80% 20%, rgba(232, 232, 232, 0.08) 0%, transparent 50%),
          linear-gradient(135deg, rgba(40, 40, 40, 0.9) 0%, rgba(50, 50, 50, 0.95) 100%)
        `,
        borderRadius: 4,
