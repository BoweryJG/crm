...
interface StandaloneEliteLoadingScreenProps {
  message?: string;
  loadingText?: string;
  showPreview?: boolean;
}
...
const StandaloneEliteLoadingScreen: React.FC<StandaloneEliteLoadingScreenProps> = ({ 
    ...
    >
      ...
      <Box
        sx={{
          ...
          borderRadius: 4,
          p: 6,
          border: '1px solid rgba(138, 96, 208, 0.3)',
      ...
      >
        ...
        >
          <Typography
            ...
            sx={{
              fontWeight: 800,
              background: 'linear-gradient(45deg, #8860D0 0%, #5CE1E6 50%, #44CFCB 100%)',
        ...
        >
          <Box
            sx={{
              height: '100%',
              background: 'linear-gradient(90deg, #8860D0 0%, #5CE1E6 50%, #44CFCB 100%)',
              borderRadius: '3px',
              transition: 'width 0.8s cubic-bezier(0.4, 0, 0.2, 1)',
              width: `${Math.min((loadingPhase + 1) * 25, 100)}%`,
              boxShadow: '0 0 20px rgba(138, 96, 208, 0.6)',
            }}
          />
        </Box>
          ...
          {previewElements.map((element, index) => (
            <Box
              ...
              sx={{
                ...
                borderRadius: 2,
                p: 2,
                border: '1px solid rgba(138, 96, 208, 0.2)',
                minWidth: '120px',
                textAlign: 'center',
                opacity: 0,
                animation: index % 3 === 0 
      ...
      <Box
        sx={{
          ...
          '&::before': {
            ...
            boxShadow: `
              0 0 6px #8860D0,
              100px 200px 0 #5CE1E6,
              200px 100px 0 #44CFCB,
              300px 300px 0 #8860D0,
              400px 50px 0 #5CE1E6
            `,
...
export default StandaloneEliteLoadingScreen;