...
export default function GlobalAuthModal({ open, onClose, onSuccess, mode = 'login' }: GlobalAuthModalProps) {
      ...
      <div className="modal-overlay" ref={modalOverlayRef}>
        ...
        <div className="login-modal" ref={modalRef}>
          ...
          <div className="logo-section">
            ...
            <h1 className="logo-title">{isSignUp ? 'Join RepSpheres' : 'Secure Access'}</h1>
            <p className="logo-subtitle">{isSignUp ? 'Create Your RepSpheres Account' : 'RepSpheres Authentication Portal'}</p>
          </div>
          ...
          {authMode === 'options' ? (
            ...
            <form className="email-form" onSubmit={handleEmailAuth}>
              ...
              <div className="form-navigation">
                <button type="button" className="nav-btn" onClick={() => setAuthMode('options')}>← Back</button>
                <button type="button" className="nav-btn" onClick={() => setIsSignUp(!isSignUp)}>
          ...
          {/* Success Flare */}
          <div className={`success-flare ${showSuccess ? 'active' : ''}`}>
