        ...
        <div className="login-modal logout-modal" ref={modalRef}>
          ...
          <div className="logo-section">
            <div className="logo-icon">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                ...
                {/* Outer sphere ring */}
                <circle cx="32" cy="32" r="24" fill="none" stroke="url(#sphereGradientLogout)" strokeWidth="3" opacity="0.8"/>
                
                {/* Inner sphere ring */}
                <circle cx="32" cy="32" r="16" fill="none" stroke="url(#sphereGradientLogout)" strokeWidth="2" opacity="0.6"/>
                
                {/* Animated Jewel Core */}
                <circle cx="32" cy="32" r="6" fill="url(#jewelGradientLogout)" className="logo-jewel">
          ...
          <div className={`loading-overlay ${isLoading ? 'active' : ''}`}>
            <svg className="loading-jewel" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
              ...
              <circle cx="24" cy="24" r="20" fill="none" stroke="url(#loadingGradientLogout)" strokeWidth="4"/>
